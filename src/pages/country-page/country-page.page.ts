...
export class CountryPage extends HTMLElement {
    ...
    async connectedCallback() {
        ...
        console.log(country)
        const {flags, name, population, region, subregion, capital, flag, currencies, languages, borders} = country[0];
        ...
        this.innerHTML = UtilsService.bindModelToView(countryTemplate, {flag: flags.svg, topLevelDomain: flag, name: name.common, maskedPopulation, nativeName: nativeName[0].common, region, subregion, capital, currency: currency[0].name, allLangs});
